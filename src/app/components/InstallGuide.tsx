  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-3xl mx-auto py-12">
        ...
        <h1 className="text-2xl mb-8 text-slate-900">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg mb-2 text-slate-900">Download Extension</h2>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg mb-2 text-slate-900">Extract ZIP File</h2>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg mb-2 text-slate-900">Open Chrome Extensions</h2>
              <p className="text-slate-600 text-sm mb-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg mb-2 text-slate-900">Enable Developer Mode</h2>
              <p className="text-slate-600 text-sm">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg mb-2 text-slate-900">Load Unpacked Extension</h2>
              <p className="text-slate-600 text-sm">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg mb-2 text-slate-900">Installation Complete</h2>
              <p className="text-slate-600 text-sm">
